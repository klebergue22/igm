...
//    private Area area;
    ...
    /** C_CONTRATO NUMBER(3,0) -> enum TipoContrato (usa tu TipoContratoConverter) */
    @Convert(converter = TipoContratoConverter.class)
    @Column(name = "C_CONTRATO", precision = 3, scale = 0)
    private TipoContrato tipoContrato;

    /** ESTADO ('V','C','P','S') -> enum EstadoContrato (usa tu EstadoContratoConverter) */
    ...
    // ==========================
    public BigDecimal getNoPersona() { return (id != null) ? id.getNoPersona() : null; }
    public BigDecimal getNoCont()    { return (id != null) ? id.getNoCont()    : null; }
}
